...
import vertexShader from './shaders/vinyl/vertex.glsl';
import fragmentShader from './shaders/vinyl/fragment.glsl';
...
export default class Vinyl {
  constructor() {
    ...
    this.resource = this.resources.items.recordPlayerModel;

    // Debug
    if (this.debug.active) {
      this.debugFolder = this.debug.ui.addFolder('Vinyl');
    }
    this.settings = {
      progress: 0,
    };
  ...
  setModel() {
    ...
    //       //   map: new THREE.TextureLoader().load('/models/RecordPlayerModel/textures/Material.001_baseColor.png'),
    //       color: 0xff00ff,
    //     });
    //   }
    // });
